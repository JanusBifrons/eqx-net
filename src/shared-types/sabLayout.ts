 ...
 *
 * Per-entity slots (words 3 onwards, SLOT_WORDS = 8 per slot):
...
export const SLOT_WORDS = 8; // slot size in 4-byte words (32 bytes)
...
/** Total SAB size in bytes: header + 1024 slots × 32 bytes = 32 780 bytes. */
