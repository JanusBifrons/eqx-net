...
export const useUIStore = create<UIStore>((set, get) => ({
  ...
  setPilotMode: (mode) => set({ pilotMode: mode }),
  ...
  setUpgradeAck: (ack) => set({ upgradeAck: ack }),
  ...
  setGalaxyPresenceLoaded: (v) => set({ galaxyPresenceLoaded: v }),
  setRosterLoaded: (v) => set({ rosterLoaded: v }),
