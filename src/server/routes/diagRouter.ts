...
// Dev endpoints — extracted to `./diag/devHandlers.ts` per the god-file
// refactor plan (commit 9). Re-exported here so existing import sites
// (index.ts, tests) continue to resolve via `./diagRouter.js`.
export {
  devStatsHandler,
  devResetSectorHandler,
  devLimboHandler,
