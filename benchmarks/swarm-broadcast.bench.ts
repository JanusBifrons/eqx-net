 ...
 */
// vitest 2.1.x bench mode does NOT run `beforeAll` reliably (samples
// drop to 0). Setup is at module load (this one is sync, so no top-level
// await needed). Measured `bench()` bodies unchanged. Guarded by
